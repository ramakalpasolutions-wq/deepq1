        ...
        <div className="about-container">
          ...
          <div className="approach-grid">
            <div className="approach-card hover-card">
              ...
              <p>We design with the future in mind.</p>
            </div>
            <div className="approach-card hover-card">
              <h4>Technology with Purpose</h4>
              <p>Practical solutions that solve real-world challenges.</p>
            </div>
            <div className="approach-card hover-card">
              <h4>Scalable & Secure</h4>
              <p>Built on robust cloud-native foundations.</p>
            </div>
            <div className="approach-card hover-card">
              <h4>Human-Centric</h4>
              <p>Prioritizing simplicity, speed, and intuitive experiences.</p>
            </div>
          </div>
        </div>
      </section>
